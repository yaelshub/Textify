...
def file_analysis(text):
    ...
    try:
        ...
        results.append(f"שגיאה בחישוב num_words: {e}")
    ...
    try:
        ...
        clean_txt = ""
        results.append(f"שגיאה ב-clean_text: {e}")
    ...
    try:
        ...
        tok = {"words": [], "sentences": []}
        results.append(f"שגיאה ב-tokenize_text: {e}")   
    ...
    try:
        ...
        results.append(f"שגיאה ב-word_info: {e}")
    ...
    try:
        ...
        results["entity_identification"] = f"שגיאה: {e}"
    ...
    try:
        ...
        words_per_sentence = []
        results.append(f"שגיאה ב-number_of_words_in_each_sentence: {e}")
    ...
    try:
        ...
        results.append(f"שגיאה ב-calculate_average_word_count: {e}")  
    try:
        ...
        results.append(f"שגיאה ב-Standard_deviation_of_the_number_of_words_in_a_sentence: {e}")
    ...
    try:
        ...
        num_words = 1
        results.append(f"שגיאה ב-number_of_words_per_text: {e}")
    ...
    try:
        ...
        word_count = {}
        results.append(f"שגיאה ב-number_of_times_a_word_appears_in_text: {e}")
    try:
        ...
        results.append(f"שגיאה ב-frequency_of_each_word: {e}")
    ...
    try:
        ...
        results.append(f"שגיאה ב-average_word_length: {e}")
    ...
    try:
        ...
        results.append(f"שגיאה ב-classify_sentence_type: {e}")
    ...
    try:
        ...
        results.append(f"שגיאה ב-get_word_frequencies: {e}")
