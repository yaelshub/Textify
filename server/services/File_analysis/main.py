...
from .clean import clean_text, clean_intro_auto
...
def main(file):
    ...
    clean_text_without_author_name= clean_intro_auto(clean_txt, max_intro_lines=100)
    tok=tokenize_text(clean_text_without_author_name)
    word_info(clean_text_without_author_name)
    # entity_identification(clean_text_without_author_name)
    # words_per_sentence=number_of_words_in_each_sentence(clean_text_without_author_name)
