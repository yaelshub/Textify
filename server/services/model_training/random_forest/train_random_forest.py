...
def train_random_forest_classifier(X_train, y_train, random_state=42):
    ...
    n_estimators=100,          # מספר עצי החלטה
    max_features='sqrt',       # מספר תכונות אקראיות בכל פיצול (sqrt = ברירת מחדל בסיווג)
    min_samples_split=2,       # מספר מינימלי של דוגמאות לצומת מפוצל
